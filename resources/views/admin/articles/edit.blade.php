...
<div class="container-fluid px-4">
    ...
    <form method="POST" action="{{ route('administrateur.articles.update', $article) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   maxlength="255">
                            <div class="form-text">URL actuelle : {{ route('articles.show', $article->slug) }}</div>
                            @error('slug')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <small class="text-muted">
                                <strong>Créé le :</strong> {{ $article->created_at->format('d/m/Y à H:i') }}<br>
                                <strong>Modifié le :</strong> {{ $article->updated_at->format('d/m/Y à H:i') }}<br>
                                @if($article->author)
                    ...
                    <div class="card-body">
                        ...
                        @if($article->featured_image)
                            <div id="current-image" class="mb-3">
                                ...
                                <div class="mt-2">
                                    <button type="button" id="change-image" class="btn btn-sm btn-outline-primary">
                                        <i class="fas fa-edit"></i> Changer l'image
                                    </button>
                                    <button type="button" id="remove-current-image" class="btn btn-sm btn-outline-danger">
                        ...
                        <!-- Upload New Image -->
                        <div id="image-upload" class="{{ $article->featured_image ? 'd-none' : '' }}">
                            <div class="mb-3">
                                <input type="file" 
                            ...
                            <div id="image-preview" class="d-none">
                                ...
                                <button type="button" id="cancel-upload" class="btn btn-sm btn-outline-secondary mt-2">
                                    <i class="fas fa-times"></i> Annuler
                                </button>
                            </div>
                        </div>
                        
                        <!-- Hidden input to mark image for removal -->
...
document.getElementById('cancel-upload')?.addEventListener('click', function() {
    ...
    if (document.getElementById('current-image')) {
        ...
        document.getElementById('image-upload').classList.add('d-none');
