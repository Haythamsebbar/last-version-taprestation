    ...
    <div class="max-w-md w-full space-y-8 bg-white p-10 rounded-lg shadow-lg">
        ...
        <form class="mt-8 space-y-6" action="{{ route('password.update') }}" method="POST">
            ...
            <div>
                ...
                <div class="mt-1">
                    <input id="password-confirm" name="password_confirmation" type="password" autocomplete="new-password" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="Confirmer le mot de passe">
                </div>
            </div>
