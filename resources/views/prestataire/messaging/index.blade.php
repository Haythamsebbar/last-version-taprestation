...
<div class="py-10">
    <header>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p class="mt-2 text-sm text-gray-600">Gérez vos conversations avec vos clients</p>
        </div>
    </header>
    <main>
            ...
            <div class="px-4 py-6 sm:px-0">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-lg font-medium text-gray-900">{{ auth()->user()->unreadMessagesCount() }}</dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white overflow-hidden shadow rounded-lg">
                        <div class="p-5">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        <dt class="text-sm font-medium text-gray-500 truncate">Réponse moyenne</dt>
                                        <dd class="text-lg font-medium text-gray-900">< 2h</dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
                ...
                <div class="bg-white shadow overflow-hidden sm:rounded-md">
                    <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                        ...
                        <p class="mt-1 max-w-2xl text-sm text-gray-500">Vos échanges avec les clients</p>
                    </div>
                    ...
                    @if($conversations->count() > 0)
                        <ul class="divide-y divide-gray-200">
                            @foreach($conversations as $conversation)
                                ...
                                @endphp
                                <li>
                                    <a href="{{ route('prestataire.messaging.show', $otherUser->id) }}" class="block hover:bg-gray-50">
                                        <div class="px-4 py-4 flex items-center justify-between">
                                            <div class="flex items-center">
                                                @if($otherUser->client && $otherUser->client->avatar)
                                                    <img class="h-10 w-10 rounded-full" src="{{ Storage::url($otherUser->client->avatar) }}" alt="{{ $otherUser->name }}">
                                                @else
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Vous n'avez pas encore de conversations avec des clients.</p>
                            <div class="mt-6">
                                <a href="{{ route('prestataire.requests.index') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
